...
let timeStopped = null;  // at what time the timer stopped?
let stoppedDuration = 0; // how long was the timer stopped?
let startInterval = null; // this is needed to stop the statyInterval() method
let flag = false; // to control start/stop of the timer
